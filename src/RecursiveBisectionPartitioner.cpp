    ...
    pid_type const offset) const
{
  ...
  solidutils::Array<pid_type> numPartsPrefix(3);
  ...
  solidutils::ArrayUtils::prefixSumExclusive(&numPartsPrefix);
...
{
  solidutils::Array<pid_type> partitionLabels(graph->getNumVertices());
